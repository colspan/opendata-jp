...
out_file = "../var/A02_population_of_each_commune_agg_by_duration_matanity_delivery.csv"
...
with open(out_file, "w") as f:
    print >> f, ",".join(["産婦人科時間距離","人口","時間距離 平均","時間距離 最大","時間距離 最小","時間距離 最大最小比"])
